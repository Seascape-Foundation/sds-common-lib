...
```sh
go get github.com/Seascape-Foundation/sds
```
...
* [sds-ts](https://github.com/Seascape-Foundation/sds-ts/) keeps the other core services that are written in Typescript.
